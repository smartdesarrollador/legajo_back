...
class EmpleadorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('empleador')->insert([
            ...
            'numero_partida_poderes' => '1234',
            'numero_asiento' => '5678',
            'oficina_registral' => 'Lima',
            'numero_partida_registral' => '87654321',
            ...
            'cargo_representante_legal' => 'Gerente de Finanzas',
            'numero_partida_poderes' => '2345',
            'numero_asiento' => '6789',
            'oficina_registral' => 'Lima',
            'numero_partida_registral' => '87654322',
            'fecha_inicio_actividades' => '2021-02-01',
            'id_user' => 2,
            'id_tipo_empleador' => 2,
            'created_at' => now(),
            'updated_at' => now()],
